...
# Player-controlled movement:
    ...
    def shoot_right(self):
        return Bullet(self.rect.x + self.rect.width/2, self.rect.y + self.rect.height/2, 30, 0, self.r, self.g, self.b)

    def shoot_left(self):
        return Bullet(self.rect.x + self.rect.width/2, self.rect.y + self.rect.height/2, -30, 0, self.r, self.g, self.b)

    def shoot_up(self):
        return Bullet(self.rect.x + self.rect.width/2, self.rect.y + self.rect.height/2, 0, -30, self.r, self.g, self.b)

    def shoot_down(self):
        bullet = Bullet(self.rect.x + self.width/2, self.rect.y + self.height/2, 0, 30, self.r, self.g, self.b)
        return bullet
